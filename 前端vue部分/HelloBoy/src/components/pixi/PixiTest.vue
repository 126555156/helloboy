<template>
  <div class="PixiTest" id="PixiTest"></div>
</template>
<script>
...
export default {
  ...
  mounted() {
    // var background = new PIXI.Sprite.fromImage(
    //   "/static/img/2018logo.8b443ba.png"
    // );
var app = new PIXI.Application(800, 600, { backgroundColor: 0x1099bb });
document.getElementById("PixiTest").appendChild(app.view);

// Scale mode for all textures, will retain pixelation

var trailTexture = PIXI.Texture.fromImage('/static/img/2018logo.8b443ba.png')
var historyX = [];
var historyY = [];
